                            ...
                            <v-container grid-list-md>
                                <v-layout wrap>
                                    <v-flex xs12 sm12 md12>
                                        <v-text-field v-model="razon_social" label="Razon Social"></v-text-field>
                                    </v-flex>
                                    <v-flex xs12 sm12 md12>
...
<script>
  ...
  export default {
    data() {
      return {
        ...
        headers: [
          ...
          {text: 'Razon social', value: 'razon_social', sortable: true},
    ...
    methods: {
      ...
      listar () {
        this.getProveedorListFromService(
          this.pagination.currentPage,
          this.pagination.perPage,

        ).then(res => {
          this.proveedores = Object.assign([], res.data.results)
        })
      },
